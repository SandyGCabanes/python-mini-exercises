...
In a tic tac toe game, the “game server” needs to know where the Xs and Os are
in the board, to know whether player 1 or player 2 (or whoever is X and O won).
...
Don’t worry about checking whether someone won the game, but if a player tries
to put a piece in a game position where there already is another piece, do not
allow the piece to go there.
Bonus:
...
print ("Tic Tac Toe Draw. Player 1 starts. \n")
...
def gameboard():
    ...
    print (game[2])
gameboard()
instruction= input("Please input row and column. Click OK to continue.")
